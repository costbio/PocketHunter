...
def cluster_pockets(args, config):
    ...
    ### TO-DO ###
    # call module that implements clustering.
    #############
...
def main():
    ...
    # Cluster pockets
    parser_convert = subparsers.add_parser("cluster_pockets",help="Clusters identified pockets based on amino acid membership one-hot vectors.")
    parser_convert.add_argument("--infolder")
    parser_convert.add_argument("--outfolder")
    parser_convert.add_argument("--method")
