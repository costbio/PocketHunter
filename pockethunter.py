...
def detect_pockets(args, config):
    ...
    extract_predict.run_p2rank(pdb_list_file, outfolder, numthreads, novis, compress, config)
...
def main():
    ...
    parser_cluster.add_argument("--infolder", type=str, help='Input folder containing PDB files (should be generated by extract_to_pdb).')
